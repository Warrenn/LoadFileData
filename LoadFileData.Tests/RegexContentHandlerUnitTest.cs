...
{
    [TestClass]
    public class RegexContentHandlerUnitTest
    {
        ...
        {
            //Arrange
            var settings = new RegexSettings(typeof (ContentData))
            {
            ...
            var handler = new RegexContentHandler(settings);
            var context = new ContentHandlerContext
            {
                FileName = "test",
                Content = new[]
                {
                    new object[] {"Name", "Value", "Index"},
